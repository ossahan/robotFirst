...
#    select checkbox  xpath=//icon[@class='trip-type__icon trip-type__icon--selected']//span[@class='_container icon-10 icon-ie-16-10']//*[name()='svg']
  ...
  input text    xpath=//*[@placeholder="Departure"]    Brussels Charleroi
  click element    xpath=//input[@id='input-button__destination']
  wait until element is enabled   xpath=//span[contains(.,'Poland')]
  click element    xpath=//span[contains(.,'Poland')]
  wait until element is enabled   xpath=//span[@data-id='POZ']
  input text    xpath=//*[@placeholder="Destination"]    Poznan
  click element    xpath=//span[@data-id='POZ']
  wait until element is enabled    xpath=//*[@class="datepicker__calendar datepicker__calendar--left"]
  click element    xpath=//*[@data-id='2022-11-29']
  ...
  #click button    xpaath=/html/body/app-root/flights-root/div/div/div/div/flights-lazy-content/fare-selector-container/fare-selector/div/fare-table-container/fare-table/div[2]/ry-spinner/div[3]/div/div/fare-card/div/div/button
